...
/* package oglg-find-0.1.0.0 */
#define VERSION_oglg_find "0.1.0.0"
#define MIN_VERSION_oglg_find(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "oglg-find-0.1.0.0-6Z77diup4v5Drh54KnpzEY"

#define CURRENT_PACKAGE_KEY "oglg-find-0.1.0.0-6Z77diup4v5Drh54KnpzEY"
